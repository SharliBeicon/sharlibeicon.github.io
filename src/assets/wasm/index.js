...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    var REMOTE_PACKAGE_BASE = "/assets/wasm/index.data";
...
var _default_context_ptr = (Module["_default_context_ptr"] =
  createExportWrapper("default_context_ptr", 0));
var _main_start = (Module["_main_start"] = createExportWrapper(
  "main_start",
  0,
));
var __start = (Module["__start"] = createExportWrapper("_start", 0));
var __end = (Module["__end"] = createExportWrapper("_end", 0));
var _main_update = (Module["_main_update"] = createExportWrapper(
  "main_update",
  0,
));
var _main_end = (Module["_main_end"] = createExportWrapper("main_end", 0));
var _web_window_size_changed = (Module["_web_window_size_changed"] =
  createExportWrapper("web_window_size_changed", 2));
